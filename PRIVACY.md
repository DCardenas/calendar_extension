...
We do not use your Google data for any purpose other than creating calendar events as requested by you.

We do not sell, share, or otherwise distribute your data to third parties.

We do not use your data for serving advertisements.

4. Authentication
   The Extension uses Chrome's standard Identity API (OAuth 2.0) to authenticate your Google account. This means you log in directly through Google. We never see, access, or store your Google password. You can revoke the Extension's access to your Google Calendar at any time by visiting your Google Account Security settings.

5. Third-Party Services
   The only third-party service this Extension communicates with is Google (specifically, the Google Calendar API) to fulfill its core functionality. We are not responsible for the privacy practices of Google. Please refer to Google's Privacy Policy for more information on how they handle your data.

6. Changes to This Privacy Policy
   We may update this Privacy Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. We will notify users of any material changes by updating the "Effective Date" at the top of this policy.
